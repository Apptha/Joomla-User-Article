...
class UserarticleViewArticle extends JView
{
   function display($tpl = null)
    {
     ...
     $search_text=JRequest::getVar('filter_text',null,'GET');

     $search_select=JRequest::getVar('filter_select',null,'GET');

     $search_category=JRequest::getVar('filter_category',null,'GET');
